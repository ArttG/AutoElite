...
<div class="dashboard-shto">
    <div class="dashboard-shto-item">
        ...
        if (isset($_POST['edito'])) {
            editoVeture($id, $_POST['marka'], $_POST['modeli'], $_POST['vitiprodhimit'], 
            $_POST['cmimi'], $_POST['karburanti'],$_POST['kilometrazha'], 
            $_FILES['img'],$_POST['ngjyra'] , $_POST['historia'], $_POST['kubik'], $_POST['transmisioni'], $emri );
            
        }
        ?>
       <form method="post" id="vetura" class="box-shto" enctype="multipart/form-data">
            <fieldset>
            <label>Marka:</label>
            ...
            <fieldset>
                ...
                <input type="text" name="kubik" id="kubik" value="<?php if(!empty($Kubik)) echo $Kubik; ?>"><br />
            </fieldset>
            <fieldset>
                <label>Cmimi:</label>
